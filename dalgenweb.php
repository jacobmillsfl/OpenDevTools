   ...
   $(document).on('click', ".DBTypePK", function() {
    ...
    function generateContent(){
        ...
        if ($('#RadioMySQL').prop('checked')) {
            ...
            for (var i = 0; i < attributeCount; i++){
                if (dalAttributes[i].PK || dalAttributes[i].FK ) {
                    ...
                    if (dalAttributes[i].FK) {
                        $('#TextareaMySQL').append("CONSTRAINT fk_" + entityName + "_" + dalAttributes[i].name + "_" + dalAttributes[i].refEntity + "_" + dalAttributes[i].refAttribute + " FOREIGN KEY (" + dalAttributes[i].name + ") REFERENCES " + dalAttributes[i].refEntity + " (" + dalAttributes[i].refAttribute + ")");
                    }
                }
            }
            ...
            for (var i = 0; i < attributeCount; i++) {
                ...
                if (isString(dalAttributes[i].type)) {
                    ...
                    // RIGHT SIDE
                    if (dalAttributes[i].castToDate) {
                        $('#TextareaMySQL').append("COALESCE(CAST(param" + dalAttributes[i].name + " AS DATE),CAST(`" + entityName + "`.`" + dalAttributes[i].name + "` AS DATE)," + "CAST(NOW() AS DATE)");
                    }
                    else {
        ...
        if ($('#CheckPHP').prop('checked')) {
            ...
            // Comments
            $('#TextareaPHP').append("/*\n");
            $('#TextareaPHP').append("Author:\t\t\tThis code was generated by DALGen Web available at https://dalgen.opendevtools.org\n");
            $('#TextareaPHP').append("Date:\t\t\t" + today + "\n");
            $('#TextareaPHP').append("Description:\t\tCreates the " + entityName + " class with methods for interacting with respective stored procedures\n");
            $('#TextareaPHP').append("\n*/\n\n");
			
			// Class definition
			$('#TextareaPHP').append("class " + entityName + " {\n");
			$('#TextareaPHP').append("\n");
			$('#TextareaPHP').append("\t// This is for local purposes only! In hosted environments the db_settings.php file should be outside of the webroot, such as: include(\"/outside-webroot/db_settings.php\");\n");
			$('#TextareaPHP').append("\tprotected static function getDbSettings() { return \"DAL/db_localsettings.php\"; }\n");
			$('#TextareaPHP').append("\n");
			
			// Properties
			$('#TextareaPHP').append("\t/******************************************************************/\n");
			$('#TextareaPHP').append("\t// Properties\n");
			$('#TextareaPHP').append("\t/******************************************************************/\n");
			$('#TextareaPHP').append("\n");
			
			for (var i = 0; i < attributeCount; i++) {
                $('#TextareaPHP').append("\tprotected $" + dalAttributes[i].name + ";\n");
			...
			$('#TextareaPHP').append("\n");
			$('#TextareaPHP').append("\t/******************************************************************/\n");
			$('#TextareaPHP').append("\t// Constructors\n");
			$('#TextareaPHP').append("\t/******************************************************************/\n");
			$('#TextareaPHP').append("\tpublic function __construct() {\n");
			$('#TextareaPHP').append("\t\t$argv = func_get_args();\n\n");
			$('#TextareaPHP').append("\t\tswitch( func_num_args() ) {\n");
			$('#TextareaPHP').append("\t\t\tcase 0:\n");
			$('#TextareaPHP').append("\t\t\t\tself::__constructBase();\n");
			$('#TextareaPHP').append("\t\t\t\tbreak;\n");
			$('#TextareaPHP').append("\t\t\tcase 1:\n");
			$('#TextareaPHP').append("\t\t\t\tself::__constructPK( $argv[0] );\n");
			$('#TextareaPHP').append("\t\t\t\tbreak;\n");
			$('#TextareaPHP').append("\t\t\tcase " + attributeCount + ":\n");
			$('#TextareaPHP').append("\t\t\t\tself::__constructFull(");
			for (var i = 0; i < attributeCount; i++) {
                $('#TextareaPHP').append("$argv[" + i + "]");
				if (i < attributeCount - 1)
					$('#TextareaPHP').append(",");
				else
					$('#TextareaPHP').append(");\n");
			...
			// Base Constructor
			$('#TextareaPHP').append("\tpublic function __constructBase() {\n");
			for (var i = 0; i < attributeCount; i++) {
                $('#TextareaPHP').append("\t\t$this->"+dalAttributes[i].name+" = " + dalAttributes[i].defaultVal + ";\n");
			}
			$('#TextareaPHP').append("\t}\n");
			$('#TextareaPHP').append("\n");
			
			// PK Constructor
			$('#TextareaPHP').append("\tpublic function __constructPK($paramId) {\n");
			$('#TextareaPHP').append("\t\t$this->load($paramId);\n");
			$('#TextareaPHP').append("\t}\n");			
			$('#TextareaPHP').append("\n");
			
			// Full Constructor
			$('#TextareaPHP').append("\tpublic function __constructFull(");
			for (var i = 0; i < attributeCount; i++) {
                $('#TextareaPHP').append("$param" + upperFirst(dalAttributes[i].name));
				if (i < attributeCount - 1)
					$('#TextareaPHP').append(",");
				else
					$('#TextareaPHP').append("){\n");
			...
			for (var i = 0; i < attributeCount; i++) {
                $('#TextareaPHP').append("\t\t$this->"+dalAttributes[i].name+" = $param" + upperFirst(dalAttributes[i].name) + ";\n");
			}
			$('#TextareaPHP').append("\t}\n");			
			$('#TextareaPHP').append("\n");
			...
			$('#TextareaPHP').append("\n");
			$('#TextareaPHP').append("\t/******************************************************************/\n");
			$('#TextareaPHP').append("\t// Accessors / Mutators\n");
			$('#TextareaPHP').append("\t/******************************************************************/\n");
